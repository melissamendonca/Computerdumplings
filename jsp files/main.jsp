...
<head>
  ...
  <title>HealthDump Dashboard</title>
  <style><%@include file="/WEB-INF/sb-admin-2.min.css"%></style>
...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="calories.jsp">
        <i class="fas fa-fw fa-tachometer-alt"></i>
        <span>Calorie</span></a>
    </li>
    <!-- Divider -->
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                      Height </div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800"> ${height} </div>
                  </div>
                  <div class="col-auto">
    ...
    <footer class="sticky-footer bg-white">
      <div class="container my-auto">
        <div class="copyright text-center my-auto">
          <span>Copyright &copy; HealthDump 2023</span>
        </div>
      </div>
    </footer>
    <!-- End of Footer -->
