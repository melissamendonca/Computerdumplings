...
public class WorkoutServlet extends HttpServlet {
    ...
    public void workoutGenerator(String s){
        ...
        if(s.contains("Abs")){ message = message + "<br>" + Abs;}
        if(s.contains("Back")){ message = message + "<br>" + Back;}
        if(s.contains("Biceps")){message = message + "<br>" + Biceps;}
        if(s.contains("Calves")){message = message + "<br>" + Calves;}
        if(s.contains("Cardio")){message = message + "<br>" + Cardio;}
        if(s.contains("Chest")){ message = message + "<br>" + Chest;}
        if(s.contains("Forearms")){ message = message + "<br>" + Forearms;}
        if(s.contains("Glutes")){message = message + "<br>" + Glutes;}
        if(s.contains("Hamstrings")){message = message + "<br>" + Hamstrings;}
        if(s.contains("Shoulders")){message = message + "<br>" + Shoulders;}
        if(s.contains("Triceps")){message = message + "<br>" + Triceps;}

        if(s.contains("Squats")){ message = message + "<br>" + Squats;}
        if(s.contains("RDLs")){ message = message + "<br>" + RDLs;}
        if(s.contains("Jump Rope")){message = message + "<br>" + JumpRope;}
        if(s.contains("Bench Press")){message = message + "<br>" + BenchPress;}
        if(s.contains("Dips")){message = message + "<br>" + Dips;}
        if(s.contains("Dumbbell Jump Squat")){ message = message + "<br>" + DumbbellJumpSquat;}
        if(s.contains("Pull-ups")){ message = message + "<br>" + Pullups;}
        if(s.contains("Overhead Press")){message = message + "<br>" + OverheadPress;}
        if(s.contains("Dumbbell Curls")){message = message + "<br>" + DumbbellCurl;}
        if(s.contains("Wrist Curls")){message = message + "<br>" + WristCurls;}
        if(s.contains("Sit-ups")){message = message + "<br>" + Situps;}
        if(s.contains("Deadlifts")){message = message + "<br>" + Deadlifts;}
        if(s.contains("Walking")){message = message + "<br>" + Walking;}
        if(s.contains("Planks")){message = message + "<br>" + Planks;}
        if(s.contains("Dumbbell Lateral Press")){message = message + "<br>" + DLP;}
